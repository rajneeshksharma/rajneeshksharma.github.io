...
document.getElementById("experienceValue").innerHTML=`${Math.abs((new Date(Date.now() - new Date("06/16/2014"))).getUTCFullYear() - 1970)}+`;
document.getElementById("experienceValue2").innerHTML=`${Math.abs((new Date(Date.now() - new Date("06/16/2014"))).getUTCFullYear() - 1970)}+`;
